...
export default function render(resolution: number, context:any, objects:Array<Object>, types: TypeDictionary) {
    ...
    for (let index = 0; index < objects.length; index++) {
        ...
        context.fillRect(Math.round(object.x / resolution) * resolution, Math.round(object.y / resolution) * resolution, resolution, resolution)
    }
}